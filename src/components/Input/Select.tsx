  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'font-regular fs-14 flex h-11.5 items-center justify-between gap-2 rounded-md border bg-transparent px-4 py-3',
        className,
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="text-gray05 size-4" />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn('text-muted-foreground fs-13 px-2 py-1.5', className)}
      {...props}
    />
  );
}
